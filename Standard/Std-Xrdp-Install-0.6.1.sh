...
# Version : 0.6.1
# History : 0.6.1 - Minor change to support 18.04.3 Point release 
...
#-----------------------------------------------------#
# Function 0  - Quick and Dirty Patch Ubuntu 18.04.*  #
#-----------------------------------------------------#
...
echo
/bin/echo -e "\e[1;36m   !-------------------------------------------------------------!\e[0m"
/bin/echo -e "\e[1;36m   !  Applying Installation Patch for Ubuntu 18.04.2/3           !\e[0m"
/bin/echo -e "\e[1;36m   !-------------------------------------------------------------!\e[0m"
echo
if [ "$unofficialRepo" = "yes" ];
then
